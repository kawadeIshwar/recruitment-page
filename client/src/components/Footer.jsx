  ...
  const socialLinks = [
    {
      ...
      href: 'https://www.linkedin.com/company/alabty/'
    },
    {
      name: 'Twitter',
      icon: (
    ...
    },
    {
      ...
      href: 'https://www.facebook.com/alabtydotcom'
    },
    {
      name: 'Instagram',
      icon: (
      ...
      href: 'https://www.instagram.com/alabty.com_official/'
    },
    {
      name: 'YouTube',
      icon: (
      ...
      href: 'https://www.youtube.com/@alabtyofficial1416'
    }
  ]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a
                  href="public/Privacy Policy-alabty.com.pdf"
                  className="text-sm text-gray-300 hover:text-white transition-colors duration-200 inline-block hover:translate-x-1 transform transition-transform"
                >
                  Privacy Policy
                </a>
              ...
              <li>
                <a
                  href="public/Terms and Conditions-alabty.com.pdf"
                  className="text-sm text-gray-300 hover:text-white transition-colors duration-200 inline-block hover:translate-x-1 transform transition-transform"
                >
                  Terms of Service
                </a>
